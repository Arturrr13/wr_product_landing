    ...
    <template #selected="{ item }">
      <div class="itemLabel">
        <!-- <SvgIcon
          ...
          :name="`flag/language`"
        /> -->
        <svg class="flagIcon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <mask id="mask0_157_1076" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
          <rect width="24" height="24" fill="#D9D9D9"/>
          </mask>
          <g mask="url(#mask0_157_1076)">
